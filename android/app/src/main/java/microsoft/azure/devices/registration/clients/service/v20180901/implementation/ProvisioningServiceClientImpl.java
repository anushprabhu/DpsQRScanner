...
import microsoft.azure.devices.registration.clients.service.v20180901.models.AttestationMechanism;
import microsoft.azure.devices.registration.clients.service.v20180901.models.BulkEnrollmentOperation;
import microsoft.azure.devices.registration.clients.service.v20180901.models.BulkEnrollmentOperationResult;
import microsoft.azure.devices.registration.clients.service.v20180901.models.DeviceRegistrationState;
import microsoft.azure.devices.registration.clients.service.v20180901.models.EnrollmentGroup;
import microsoft.azure.devices.registration.clients.service.v20180901.models.IndividualEnrollment;
import microsoft.azure.devices.registration.clients.service.v20180901.models.ProvisioningServiceErrorDetailsException;
import microsoft.azure.devices.registration.clients.service.v20180901.models.QueryDeviceRegistrationStatesHeaders;
import microsoft.azure.devices.registration.clients.service.v20180901.models.QueryEnrollmentGroupsHeaders;
import microsoft.azure.devices.registration.clients.service.v20180901.models.QueryIndividualEnrollmentsHeaders;
import microsoft.azure.devices.registration.clients.service.v20180901.models.QuerySpecification;
...
public class ProvisioningServiceClientImpl extends ServiceClient implements ProvisioningServiceClient {
    ...
    interface ProvisioningServiceClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient getIndividualEnrollment" })
        @GET("enrollments/{id}")
        Observable<Response<ResponseBody>> getIndividualEnrollment(@Path("id") String id, @Query("api-version") String apiVersion);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient createOrUpdateIndividualEnrollment" })
        @PUT("enrollments/{id}")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient deleteIndividualEnrollment" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient getEnrollmentGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient createOrUpdateEnrollmentGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient deleteEnrollmentGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient getDeviceRegistrationState" })
        @GET("registrations/{id}")
        Observable<Response<ResponseBody>> getDeviceRegistrationState(@Path("id") String id, @Query("api-version") String apiVersion);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient deleteDeviceRegistrationState" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient queryIndividualEnrollments" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient getIndividualEnrollmentAttestationMechanism" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient runBulkEnrollmentOperation" })
        @POST("enrollments")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient queryEnrollmentGroups" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient getEnrollmentGroupAttestationMechanism" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: microsoft.azure.devices.registration.clients.service.v20180901.ProvisioningServiceClient queryDeviceRegistrationStates" })
        @POST("registrations/{id}/query")
        Observable<Response<ResponseBody>> queryDeviceRegistrationStates(@Path("id") String id, @Header("x-ms-max-item-count") Integer xMsMaxItemCount, @Header("x-ms-continuation") String xMsContinuation, @Query("api-version") String apiVersion);
    ...
    public ServiceFuture<List<DeviceRegistrationState>> queryDeviceRegistrationStatesAsync(String id, final ServiceCallback<List<DeviceRegistrationState>> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(queryDeviceRegistrationStatesWithServiceResponseAsync(id), serviceCallback);
    }
    ...
    public Observable<List<DeviceRegistrationState>> queryDeviceRegistrationStatesAsync(String id) {
        return queryDeviceRegistrationStatesWithServiceResponseAsync(id).map(new Func1<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>, List<DeviceRegistrationState>>() {
            @Override
            public List<DeviceRegistrationState> call(ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the List&lt;DeviceRegistrationState&gt; object
     */
    public Observable<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>> queryDeviceRegistrationStatesWithServiceResponseAsync(String id) {
        if (id == null) {
            throw new IllegalArgumentException("Parameter id is required and cannot be null.");
        }
        if (this.apiVersion() == null) {
        ...
        final Integer xMsMaxItemCount = null;
        final String xMsContinuation = null;
        return service.queryDeviceRegistrationStates(id, xMsMaxItemCount, xMsContinuation, this.apiVersion())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders> clientResponse = queryDeviceRegistrationStatesDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
     ...
     * @return the List&lt;DeviceRegistrationState&gt; object if successful.
     */
    public List<DeviceRegistrationState> queryDeviceRegistrationStates(String id, Integer xMsMaxItemCount, String xMsContinuation) {
        return queryDeviceRegistrationStatesWithServiceResponseAsync(id, xMsMaxItemCount, xMsContinuation).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<DeviceRegistrationState>> queryDeviceRegistrationStatesAsync(String id, Integer xMsMaxItemCount, String xMsContinuation, final ServiceCallback<List<DeviceRegistrationState>> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(queryDeviceRegistrationStatesWithServiceResponseAsync(id, xMsMaxItemCount, xMsContinuation), serviceCallback);
    }
     ...
     * @return the observable to the List&lt;DeviceRegistrationState&gt; object
     */
    public Observable<List<DeviceRegistrationState>> queryDeviceRegistrationStatesAsync(String id, Integer xMsMaxItemCount, String xMsContinuation) {
        return queryDeviceRegistrationStatesWithServiceResponseAsync(id, xMsMaxItemCount, xMsContinuation).map(new Func1<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>, List<DeviceRegistrationState>>() {
            @Override
            public List<DeviceRegistrationState> call(ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders> response) {
                return response.body();
            }
     ...
     * @return the observable to the List&lt;DeviceRegistrationState&gt; object
     */
    public Observable<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>> queryDeviceRegistrationStatesWithServiceResponseAsync(String id, Integer xMsMaxItemCount, String xMsContinuation) {
        if (id == null) {
            throw new IllegalArgumentException("Parameter id is required and cannot be null.");
        }
        if (this.apiVersion() == null) {
    ...
    private ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders> queryDeviceRegistrationStatesDelegate(Response<ResponseBody> response) throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException {
        return this.restClient().responseBuilderFactory().<List<DeviceRegistrationState>, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
                ...
                .registerError(ProvisioningServiceErrorDetailsException.class)
                .buildWithHeaders(response, QueryDeviceRegistrationStatesHeaders.class);
    }
