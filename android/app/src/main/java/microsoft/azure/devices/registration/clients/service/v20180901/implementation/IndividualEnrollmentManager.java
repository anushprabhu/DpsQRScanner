...
import com.microsoft.azure.devices.dps.dpsqrscanner.ContractApiHttp;
import com.microsoft.azure.devices.dps.dpsqrscanner.HttpMethod;
import com.microsoft.azure.devices.dps.dpsqrscanner.HttpResponse;
import com.microsoft.azure.devices.dps.dpsqrscanner.Tools;
...

{
    ...
    public IndividualEnrollment createOrUpdate(IndividualEnrollment individualEnrollment) throws IOException

    {
        ...
        String id = individualEnrollment.registrationId();
        ...
        Gson gson = new Gson();
        String enrollmentPayload = gson.toJson(individualEnrollment);
        ...
        if(!Tools.isNullOrEmpty(individualEnrollment.etag()))

        {

            headerParameters.put(CONDITION_KEY, individualEnrollment.etag());
...
//        }
        ...
        return gson.fromJson(str, IndividualEnrollment.class);
