...
/**
 * Defines headers for QueryDeviceRegistrationStates operation.
 */
public class QueryDeviceRegistrationStatesHeaders {
    /**
     ...
     * @return the QueryDeviceRegistrationStatesHeaders object itself.
     */
    public QueryDeviceRegistrationStatesHeaders withXMsContinuation(String xMsContinuation) {
     ...
     * @return the QueryDeviceRegistrationStatesHeaders object itself.
     */
    public QueryDeviceRegistrationStatesHeaders withXMsMaxItemCount(Integer xMsMaxItemCount) {
     ...
     * @return the QueryDeviceRegistrationStatesHeaders object itself.
     */
    public QueryDeviceRegistrationStatesHeaders withXMsItemType(String xMsItemType) {
