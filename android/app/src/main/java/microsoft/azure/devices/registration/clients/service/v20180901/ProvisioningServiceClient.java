...
package microsoft.azure.devices.registration.clients.service.v20180901;
...
public interface ProvisioningServiceClient {
    ...
    */
     ...
     * @return the observable to the List&lt;DeviceRegistrationState&gt; object
     */
    Observable<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>> queryDeviceRegistrationStatesWithServiceResponseAsync(String id);
    /**
     * Gets the registration state of devices in this enrollmentGroup.
     *
     * @param id Enrollment group ID.
     ...
     * @return the List&lt;DeviceRegistrationState&gt; object if successful.
     */
    List<DeviceRegistrationState> queryDeviceRegistrationStates(String id, Integer xMsMaxItemCount, String xMsContinuation);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<List<DeviceRegistrationState>> queryDeviceRegistrationStatesAsync(String id, Integer xMsMaxItemCount, String xMsContinuation, final ServiceCallback<List<DeviceRegistrationState>> serviceCallback);
     ...
     * @return the observable to the List&lt;DeviceRegistrationState&gt; object
     */
    Observable<List<DeviceRegistrationState>> queryDeviceRegistrationStatesAsync(String id, Integer xMsMaxItemCount, String xMsContinuation);
     ...
     * @return the observable to the List&lt;DeviceRegistrationState&gt; object
     */
    Observable<ServiceResponseWithHeaders<List<DeviceRegistrationState>, QueryDeviceRegistrationStatesHeaders>> queryDeviceRegistrationStatesWithServiceResponseAsync(String id, Integer xMsMaxItemCount, String xMsContinuation);
