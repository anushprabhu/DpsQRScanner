 ...
 */
public class QueryIndividualEnrollmentsHeaders {
    /**
     ...
     * @return the QueryIndividualEnrollmentsHeaders object itself.
     */
    public QueryIndividualEnrollmentsHeaders withXMsContinuation(String xMsContinuation) {
     ...
     * @return the QueryIndividualEnrollmentsHeaders object itself.
     */
    public QueryIndividualEnrollmentsHeaders withXMsMaxItemCount(Integer xMsMaxItemCount) {
     ...
     * @return the QueryIndividualEnrollmentsHeaders object itself.
     */
    public QueryIndividualEnrollmentsHeaders withXMsItemType(String xMsItemType) {
