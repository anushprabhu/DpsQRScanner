...
//        try
    ...
    private HttpRequest createRequest(URL url, HttpMethod method, Map<String, String> headerParameters, byte[] payload, String sasToken) throws IOException
...
//        }
...

    {
        ...
        stringBuilder.append("2018-09-01-preview");
